 ...
 */
@ccclass
@menu("添加特殊行为/Animate/Pop Animate (弹窗动画)")
@disallowMultiple
export default class BhvPopAnimate extends cc.Component {
    ...
    public playIn(delay:number = 0){
        this.onPlayAnimationIn(delay);
    }

    public playOut(delay:number =0){
        this.onPlayAnimationOut(delay);
    }
